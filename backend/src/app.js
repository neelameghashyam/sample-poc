...
import { update as updateCh04, createPropMethod as createCh04Pm, updatePropMethod as updateCh04Pm, deletePropMethod as deleteCh04Pm } from './handlers/chapters/chapter-04.js';
import { update as updateCh05 } from './handlers/chapters/chapter-05.js';
...
app.post('/api/test-guidelines/:id/chapters/04/propagation-methods', createCh04Pm);
app.patch('/api/test-guidelines/:id/chapters/04/propagation-methods/:pmId', updateCh04Pm);
app.delete('/api/test-guidelines/:id/chapters/04/propagation-methods/:pmId', deleteCh04Pm);
