  ...
  <div class="archived-view">
    <div class="stat-cards">
      <StatCard
        ...
        :key="card.code"
        :label="card.label"
        :count="card.code === 'all' ? (store.stats.archive || 0) : (store.stats.twpCounts?.archived?.[card.code] || 0)"
    ...
    <TestGuidelinesTable
      ...
      :date-column="{ key: 'statusDate', label: 'Archived Date' }"
...
.archived-view :deep(.data-table__wrapper) {
